class Renderer {
    constructor(x, y, width, height){
        if (Renderer._instance) return this._instance;
    ...
    submit(shader, vertexArray) {
        if (!shader) console.warn("The shader is undefined", shader);
        if (!vertexArray) consoel.warn("The vertexArray is  undefined");
        if (this._shader) this._shader.unbind();
        if (this._vertexArray) this._vertexArray.unbind();
        this._shader = shader;
...
//# sourceMappingURL=index.6c5e14aa.js.map
