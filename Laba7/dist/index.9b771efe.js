(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/ }({
        /***/ "./src/index.ts": /*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/ /*! exports provided: OBJ, Attribute, DuplicateAttributeException, Layout, Material, MaterialLibrary, Mesh, TYPES, downloadModels, downloadMeshes, initMeshBuffers, deleteMeshBuffers, version */ /***/ function(module1, __webpack_exports__, __webpack_require__) {
            "use strict";
 ...
 */ /***/ },
        /***/ "./src/layout.ts": /*!***********************!*\
  !*** ./src/layout.ts ***!
  \***********************/ /*! exports provided: TYPES, DuplicateAttributeException, Attribute, Layout */ /***/ function(module1, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
 ...
 */ class Layout {
     ...
     */ constructor(...attributes){
                    ...
                    for (const attribute of attributes){
                        if (this.attributeMap[attribute.key]) throw new DuplicateAttributeException(attribute);
                    ...
                    this.stride = offset;
                    for (const attribute of attributes)this.attributeMap[attribute.key].stride = this.stride;
                }
            }
            // Geometry attributes
            /**
 ...
 */ Layout.MATERIAL_INDEX = new Attribute("materialIndex", 1, TYPES.SHORT);
        ...
        /***/ "./src/material.ts": /*!*************************!*\
  !*** ./src/material.ts ***!
  \*************************/ /*! exports provided: Material, MaterialLibrary */ /***/ function(module1, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
 ...
 */ class MaterialLibrary {
         ...
         */ this.currentMaterial = SENTINEL_MATERIAL;
                ...
                /* eslint-disable camelcase */ /* the function names here disobey camelCase conventions
     ...
     * of the color.
     */ parseColor(tokens) {
                    if (tokens[0] == "spectral") throw new Error("The MTL parser does not support spectral curve files. You will need to convert the MTL colors to either RGB or CIEXYZ.");
                    if (tokens[0] == "xyz") throw new Error("The MTL parser does not currently support XYZ colors. Either convert the XYZ values to RGB or create an issue to add support for XYZ");
     ...
     */ parse_ost(values, option, defaultValue) {
                    while(values.length < 3)values.push(defaultValue.toString());
     ...
     */ parseOptions(tokens) {
                    ...
                    while(tokens.length){
                        ...
                        } else if (option) optionsToValues[option].push(token);
                    }
                    for(option in optionsToValues){
                        if (!optionsToValues.hasOwnProperty(option)) continue;
                        values = optionsToValues[option];
                        const optionMethod = this[`parse_${option}`];
                        if (optionMethod) optionMethod.bind(this)(values, options);
                    }
                    return options;
                }
                /**
     ...
     */ parseMap(tokens) {
                    ...
                    let optionsString;
                    let filename = "";
                    if (!tokens[0].startsWith("-")) [filename, ...optionsString] = tokens;
                    else {
                        filename = tokens.pop();
     ...
     */ constructor(objectData, options){
       ...
       */ const verts = [];
                    ...
                    for (let line of lines){
                        ...
                        elements.shift();
                        if (VERTEX_RE.test(line)) // if this is a vertex
                        verts.push(...elements);
                        else if (NORMAL_RE.test(line)) // if this is a vertex normal
                        vertNormals.push(...elements);
                            ...
                            if (elements.length > 2 && !options.enableWTextureCoord) coords = elements.slice(0, 2);
                            else if (elements.length === 2 && options.enableWTextureCoord) // If for some reason W texture coordinate support is enabled
                            ...
                            if (!(materialName in materialIndicesByName)) {
                                ...
                                if (materialIndicesByName[materialName] > 0) unpacked.indices.push([]);
                            }
                ...
                */ const triangles = triangulate(elements);
                            for (const triangle of triangles)for(let j = 0, eleLen = triangle.length; j < eleLen; j++){
                                const hash = triangle[j] + "," + currentMaterialIndex;
                                if (hash in unpacked.hashindices) unpacked.indices[currentObjectByMaterialIndex].push(unpacked.hashindices[hash]);
                                else {
                                    /*
                         ...
                         */ // Vertex position
                                    ...
                                    if (textures.length) {
                                        ...
                                        if (options.enableWTextureCoord) unpacked.textures.push(+textures[(+vertex[1] - 1) * stride + 2]);
                                    }
                                    // Vertex normals
                    ...
                    this.materialsByIndex = {};
                    if (options.calcTangentsAndBitangents) this.calculateTangentsAndBitangents();
                }
                /**
     ...
     */ makeBufferData(layout) {
                ...
                addMaterialLibrary(mtl) {
                    for(const name in mtl.materials){
                        if (!(name in this.materialIndices)) continue;
            ...
            function* triangulate(elements) {
                ...
                } else for(let i = 1; i < elements.length - 1; i++)yield [
                    elements[0],
                    elements[i],
                    elements[i + 1]
                ];
        ...
        /***/ "./src/utils.ts": /*!**********************!*\
  !*** ./src/utils.ts ***!
  \**********************/ /*! exports provided: downloadModels, downloadMeshes, initMeshBuffers, deleteMeshBuffers */ /***/ function(module1, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            ...
            function getMtl(modelOptions) {
                if (!(typeof modelOptions.mtl === "string")) return modelOptions.obj.replace(/\.obj$/, ".mtl");
 ...
 */ function downloadModels(models) {
                ...
                for (const model of models){
                    if (!model.obj) throw new Error('"obj" attribute of model object not set. The .obj file is required to be set in order to use downloadModels()');
                    const options = {
                    ...
                    const meshPromise = fetch(model.obj).then((response)=>response.text()).then((data)=>{
                    ...
                    if (model.mtl) {
                        ...
                        mtlPromise = fetch(mtl).then((response)=>response.text()).then((data)=>{
                            ...
                            if (model.downloadMtlTextures !== false) {
                                ...
                                if (!root) // get the directory of the MTL file as default
                ...
                return Promise.all(finished).then((ms)=>{
                    ...
                    for (const model of ms){
                        ...
                        mesh.name = name;
                        if (mtl) mesh.addMaterialLibrary(mtl);
                        models[name] = mesh;
                    }
                    return models;
                });
 ...
 */ function downloadMeshes(nameAndURLs, completionCallback, meshes) {
                ...
                for(const mesh_name in nameAndURLs){
                    if (!nameAndURLs.hasOwnProperty(mesh_name)) continue;
                    const url = nameAndURLs[mesh_name];
                    completed.push(fetch(url).then((response)=>response.text()).then((data)=>{
                        return [
                            mesh_name,
                ...
                Promise.all(completed).then((ms)=>{
                    for (const [name, mesh] of ms)meshes[name] = mesh;
 ...
 */ function initMeshBuffers(gl, mesh) {
  ...
  \****************************/ /*! no static exports found */ /***/ function(module1, exports1, __webpack_require__) {
            module1.exports = __webpack_require__(/*! /home/aaron/google_drive/projects/webgl-obj-loader/src/index.ts */ "./src/index.ts");
        /***/ }
    });
});

//# sourceMappingURL=index.9b771efe.js.map
