...
function buildShaders() {
    for(const shader in SHADERS)if (!SHADERS[shader].build()) {
...
async function main() {
    ...
    const renderObjectRecursively = function(object) {
        ...
        if (meshRenderer) {
            ...
            material.setLightInfo("u_LightInfos[0]", lightCube.globalPosition, [
                0,
                0,
                0
            ], [
            ...
            material.setLightInfo("u_LightInfos[1]", headlightL.globalPosition, headlightL.getRelativeDirection(1.0, -1, 0.0), [
                1.0,
                1.0,
                1.0
            ], lightSize, 1);
            material.setLightInfo("u_LightInfos[2]", headlightR.globalPosition, headlightR.getRelativeDirection(1.0, -1, 0.0), [
                1.0,
                1.0,
                1.0
            ], lightSize, 1);
