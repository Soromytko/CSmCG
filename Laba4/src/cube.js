class Cube {
    ...
    createBuffers(gl) {
        ...
        const normalAttribLocation = gl.getAttribLocation(this._shaderProgram, 'vertexNormal')
        gl.vertexAttribPointer(normalAttribLocation, 3, gl.FLOAT, gl.FALSE, 0, 0)
        gl.enableVertexAttribArray(normalAttribLocation)
        this._normalAttribLocation = normalAttribLocation
    ...
    render(gl, baseMatrix, ambient) {
        ...
        // Lights
        const u_Ambient = gl.getUniformLocation(this._shaderProgram, "u_AmbientStrength")
        gl.uniform1f(u_Ambient, ambient)
        gl.uniform3f(gl.getUniformLocation(this._shaderProgram, 'u_LightDirection'), -1, -1, 0)
